...
O painel também lista os livros cadastrados. Para apagar um registro duplicado, informe a senha administrativa e clique em **Excluir**. As tags da página inicial são recalculadas automaticamente a partir dos livros restantes.

Cada tag recebe automaticamente uma cor suave e consistente. A mesma tag mantém a mesma cor nos filtros e nos cards.
